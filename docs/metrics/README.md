...
Real Search Console Pages/Queries/Chart, Short.io API and Nord partner CSV exports now exist for **28 July–10 August 2026**; see [gsc-export-2026-08-12.md](./gsc-export-2026-08-12.md), [shortio-export-2026-08-12.md](./shortio-export-2026-08-12.md), [nord-partner-export-2026-08-13.md](./nord-partner-export-2026-08-13.md) and the joined [post-14d-2026-08-13.json](./post-14d-2026-08-13.json). `measure:check-inputs` reports `ready: true` and the partner window is matched, but the Nord rows only identify `Cyber 3y deal` and `Default`; they cannot be joined to individual Short.io/page slugs. Keep the next 4–8 page selection paused until that attribution field is available. The planned comparison checkpoint remains **25 August 2026**.
