...
- Search Console Pages and Queries are real authenticated exports and pass header/size validation.
...
The machine-readable version is [measurement-window-manifest-2026-08-12.json](./measurement-window-manifest-2026-08-12.json). The conversion gate remains `matched: false` and `ready: false` until a downloadable Nord export for the same window provides clicks, conversions, payout/revenue and EPC.
