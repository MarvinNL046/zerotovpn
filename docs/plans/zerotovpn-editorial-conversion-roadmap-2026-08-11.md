...
- This is a controlled existing-page refresh. It is ready for deployment verification, but it does not close the matched Nord partner-export gate or justify a new trial variant.
