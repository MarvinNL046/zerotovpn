...
- **11 August 2026:** Added `npm run audit:editorial-live` as a page-level release gate for the ten English commercial/cluster pages. It checks metadata, canonical/indexability, one H1, disclosure, methodology, required anchors, FAQ schema, internal links and affiliate rel attributes. The live run passes **10/10 pages** with 72 affiliate links and 0 missing `sponsored nofollow` attributes. Evidence: [editorial-live-audit-2026-08-11.md](../metrics/editorial-live-audit-2026-08-11.md).
