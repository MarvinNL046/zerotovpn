...
- **11 August 2026:** Added the canonical English supporting page `/guides/vpn-obfuscation-explained` from the protocol DataForSEO/PAA brief. It answers what obfuscation does, what it cannot promise, platform/protocol evidence to save, a bounded test plan, FAQ schema and links back to the censorship and protocol clusters. Local desktop/390px browser checks pass with six compliant CTA links and no overflow; production deployment is the next release gate.
