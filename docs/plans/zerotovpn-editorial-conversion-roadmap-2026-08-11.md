...
- Local verification: `npm run audit:editorial` **43/43**, `npm run lint` 0 errors (53 existing warnings), and `npm run build` generated **4,447** pages. Deployment and live Telegram smoke results are recorded after production verification.
