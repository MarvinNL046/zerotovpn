...
| Page-level content brief contract on the commercial pillar | Complete | `src/lib/editorial-content-brief.ts`, live attributes on `/best/best-vpn`, and [content-brief browser smoke](../metrics/content-brief-browser-smoke-2026-08-12.md); content-brief failure count 0 |
