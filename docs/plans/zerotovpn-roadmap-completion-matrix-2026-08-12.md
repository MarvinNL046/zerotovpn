...
| Partner conversions, revenue and EPC joined | Dated aggregate export joined; page attribution incomplete | [Nord partner export note](../metrics/nord-partner-export-2026-08-13.md) records the real 28 Jul–10 Aug CSV: 2 dated clicks, 0 conversions, $0 payout and $0 EPC. The offer labels do not expose the Short.io page slug, so totals are diagnostic and cannot rank page-level conversion performance |
...
4. Resolve the shared sub-ID/short-link field (or obtain a partner export that includes it) before selecting the next 4–8 pages from measured cluster winners, not from historical volume alone.
