...
| Page-level content brief contract across audited cluster pages | Complete | `src/lib/editorial-content-brief.ts` + centralized cluster map, live attributes on 10 core commercial/censorship/protocol/travel/free routes, and [content-brief browser smoke](../metrics/content-brief-browser-smoke-2026-08-12.md); content-brief failure count 0 |
