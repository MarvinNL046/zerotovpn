...
const targets = [
  ...
  { path: "/best/vpn-iphone", name: "iPhone VPN comparison", ids: ["quick-picks", "comparison", "setup", "faq", "sources"], links: ["/best/vpn-mobile", "/best/vpn-android", "/best/vpn-privacy", "/guides/vpn-protocols-explained", "/methodology"], expectFaq: true, expectTable: true, brief: { primaryKeyword: "best vpn for iphone", intent: "commercial", cluster: "mobile-and-device-privacy", lastReviewedAt: "2026-08-13", affiliateContext: "vpn-selection", schemaType: "CollectionPage" } },
  { path: "/best/vpn-ipad", name: "iPad VPN comparison", ids: ["quick-picks", "comparison", "setup", "faq", "sources"], links: ["/best/vpn-mobile", "/best/vpn-iphone", "/best/vpn-privacy", "/best/vpn-android-tablet", "/methodology"], expectFaq: true, expectTable: true, brief: { primaryKeyword: "best vpn for ipad", intent: "commercial", cluster: "mobile-and-device-privacy", lastReviewedAt: "2026-08-13", affiliateContext: "vpn-selection", schemaType: "CollectionPage" } },
  { path: "/best/vpn-macos", name: "macOS VPN comparison", ids: ["quick-picks", "comparison", "setup", "faq", "sources"], links: ["/best/vpn-laptops", "/best/vpn-iphone", "/best/vpn-ipad", "/best/vpn-privacy", "/guides/vpn-protocols-explained", "/methodology"], expectFaq: true, expectTable: true, brief: { primaryKeyword: "best vpn for macos", intent: "commercial", cluster: "mobile-and-device-privacy", lastReviewedAt: "2026-08-13", affiliateContext: "vpn-selection", schemaType: "CollectionPage" } },
