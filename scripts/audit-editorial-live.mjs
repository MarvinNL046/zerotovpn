...
const targets = [
  ...
  { path: "/reviews/nordvpn", name: "NordVPN review", ids: [], links: ["/best/best-vpn", "/methodology", "/affiliate-disclosure"], expectFaq: true, expectTable: false },
  { path: "/reviews/surfshark", name: "Surfshark review", ids: [], links: ["/reviews/nordvpn", "/methodology", "/affiliate-disclosure"], expectFaq: true, expectTable: false },
