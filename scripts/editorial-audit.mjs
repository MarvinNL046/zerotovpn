...
const checks = [
  ...
  },
  {
    ...
    patterns: [
      /normaliseerAffiliateLinks\(html: string, pathname\?/,
      /withNordAffiliateSubId/,
      /data-affiliate-sub-id/,
    ],
  },
  {
  ...
  {
    name: "affiliate resolver fails closed without explicit approval and URL",
    file: "src/lib/vpn-links.ts",
    patterns: [
      /VPN_APPROVED_AFFILIATE_IDS/,
      /AFFILIATE_VPN_NORDVPN_URL/,
      /configuredAffiliateUrls/,
      /approvedAffiliateIds\.has\(slug\)/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /<h3>Which VPN is best for Telegram\?<\/h3>/,
      /DataForSEO/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /scope=\"col\"/,
      /VPN for Russia 2026: obfuscation/,
    ],
  },
  {
    ...
    patterns: [
      /VPN for Russia 2026: Obfuscation, Setup & What to Verify/,
      /Compare VPN options for Russia by obfuscation, app access and privacy evidence/,
    ],
    forbiddenPatterns: [
      /VPN for Russia in 2026: What to Verify Before You Connect/,
    ],
  },
  {
    ...
    patterns: [
      /August 13, 2026/,
      /Which VPNs work in Russia in 2026\?/,
      /Which VPN supports Russia\?/,
      /Can you use a VPN in Russia\?/,
      /fetched August 13, 2026/,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /Can you use a VPN in Vietnam\?/,
      /Which VPN works best in Vietnam\?/,
      /Is VPN use legal in Vietnam\?/,
      /Should I install a VPN before travelling to Vietnam\?/,
      /What to verify before choosing/,
      /A bounded Vietnam test plan/,
      /2026/,
    ],
    forbiddenPatterns: [
      /94%|92%|90%|87%|reliably bypass|most restrictive.*Southeast Asia|guarantee.*(bypass|circumvent).*Vietnam/i,
    ],
  },
  {
    ...
    patterns: [
      /VietnamVpnEditorialPage/,
      /locale !== "en"/,
      /createLegacyCountryEvidenceMetadata/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /What is the best free VPN for the USA\?/,
    ],
  },
  {
  ...
  {
    name: "Best VPN route uses the curated EN/NL roundup component",
  ...
  {
    name: "Best VPN route redirects unsupported locales to English",
    file: "src/app/[locale]/best/best-vpn/page.tsx",
    patterns: [
      /if \(!isBestVpnRoundupLocale\(locale\)\) permanentRedirect/,
  ...
  },
  {
    ...
    forbiddenPatterns: [
      /battery impact \(3-5%\)|\(~[0-9]+%\)|Fastest connection speeds|expert-tested/i,
    ],
  },
  {
    ...
    patterns: [
      /LaptopVpnEditorialPage/,
      /locale === "en"/,
      /laptopVpnEditorialTitle/,
      /laptopVpnEditorialDescription/,
    ],
  },
  {
    ...
    forbiddenPatterns: [
      /battery impact \(~[0-9]+%\)|[0-9]\.[0-9]\/5|Fastest speeds|unlimited devices/i,
    ],
  },
  {
  ...
  {
    name: "iPad VPN English route uses bounded iPadOS evidence",
    file: "src/components/editorial/ipad-vpn-editorial-page.tsx",
    patterns: [
      /Best VPNs for iPad in 2026/,
      /id="quick-picks"/,
      /id="comparison"/,
      /id="setup"/,
      /id="faq"/,
    ...
    forbiddenPatterns: [
      /battery impact \(~[0-9]+%\)|[0-9]\.[0-9]\/5|Fastest speeds|expert-tested/i,
    ],
  },
  {
    name: "iPad route uses audited English editorial component",
    file: "src/app/[locale]/best/vpn-ipad/page.tsx",
    patterns: [
      /IpadVpnEditorialPage/,
      /locale === "en"/,
  ...
  },
  {
    ...
    forbiddenPatterns: [
      /battery impact \(~[0-9]+%\)|[0-9]\.[0-9]\/5|Fastest speeds|expert-tested|app size/i,
      /AffiliateTextLink|priceTwoYear|priceYearly|priceLastVerified|money\(/,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /MacosVpnEditorialPage/,
      /const allVpns = await getAllVpns/,
      /locale=\{locale\}/,
      /macosVpnEditorialTitle/,
      /macosVpnEditorialDescription/,
    ],
  },
  {
    ...
    file: "src/app/[locale]/best/vpn-macos/page.tsx",
    patterns: [
      /every locale on the audited evidence-led template/,
      /fixed app sizes, test counts and optimization guarantees/,
      /MacosVpnEditorialPage vpns=\{allVpns\} locale=\{locale\}/,
    ],
  },
  {
    name: "Best VPN metadata promises a bounded decision shortlist",
    file: "src/data/best-vpn-roundup.ts",
    patterns: [
      /Best VPN in 2026: 3 Clear Starting Points/,
      /No mystery scores, old prices or fixed winner/,
    ],
    forbiddenPatterns: [/tested and ranked|fastest VPN|guaranteed winner/i],
  },
  {
  ...
  },
  {
    ...
    patterns: [/dateModified: "2026-08-16"/],
    forbiddenPatterns: [/dateModified="2026-11-28"/],
  },
  {
    ...
    patterns: [
      ...
      /Compare obfuscation, app access and privacy evidence for Iran/,
    ],
    forbiddenPatterns: [
  ...
  },
  {
    ...
    patterns: [
      ...
      /ipadVpn:/,
      /macosVpn:/,
      /censorship-restricted-networks/,
      /protocol-and-technical-literacy/,
  ...
  },
  {
    ...
    file: "src/lib/editorial-content-briefs.ts",
    patterns: [
      /russia:[\s\S]*lastReviewedAt: "2026-08-13"/,
      /dataforseo-russia-cluster-2026-08-13\.md/,
    ],
  },
  {
    name: "shared quick-pick cards use branded marks without ratings or fixed prices",
    file: "src/components/editorial/best-vpn-editorial-template.tsx",
    patterns: [
      /without catalog ratings or stale price claims/,
    ...
    forbiddenPatterns: [/RatingStars/, /data-plan-context="true"/],
  },
  {
    name: "Best VPN roundup avoids scores, stale prices and a fixed winner",
    file: "src/data/best-vpn-roundup.ts",
    patterns: [
      /0.*overall scores/,
      /0.*fixed price claims/,
      /No mystery scores, old prices or fixed winner/,
    ],
    forbiddenPatterns: [
      /35\+|35以上|35개 이상|35款以上|plus de 35|über 35|มากกว่า 35/i,
      /500\+|500回|500회|500多次|plus de 500|über 500|มากกว่า 500/i,
      /6,730|7,000\+.*118|24\/7/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /actuele providerinformatie/,
      /fünf VPN-Anbieter/,
      /cinco proveedores/,
      /cinq fournisseurs/,
    ],
    forbiddenPatterns: [
      /50\+ VPN|over 50 VPN|more than 50 VPN|plus de 50 VPN|uber 50 VPN|mas de 50 VPN/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /best vpn for iran/,
      /censorship-restricted-networks/,
      /brief=\{[\s\S]*?isIranEditorial[\s\S]*?isFitnessTrackingPrivacyEditorial/,
    ],
    forbiddenPatterns: [
      /articleContent = isRestrictedAffiliateContext\s*\?\s*verwijderAffiliateLinks\(post\.content\)/i,
    ],
  },
  {
    name: "about page uses verifiable trust signals",
    file: "src/data/about-page.ts",
    patterns: [
      /Important claims should show their source, date and limit/,
      /There is no need to invent a large expert team/,
      /A named organisation examined a defined claim/,
      /ZeroToVPN does not claim/,
      /turn a provider claim into evidence/,
    ],
    forbiddenPatterns: [
      /100K\+|100,000\+|Monthly Readers|monthly readers|50\+|over 50|tested and reviewed over 50|500\+|200\+/i,
    ],
  },
  {
    ...
    patterns: [
      /We compare several VPNs for Linux/,
      /We vergelijken meerdere VPN-providers op Linux/,
    ],
    forbiddenPatterns: [
      /35\+|35以上|35개|35个|über 35|más de 35|plus de 35|มากกว่า 35/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /Which VPN has the best Linux support\?/,
      /Six Linux checks before you subscribe/,
    ],
    forbiddenPatterns: [
      /expert-tested|fastest VPN protocol|military-grade|35\+|stable speeds|best overall Linux VPN/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /We compare several VPNs for Windows/,
      /We vergelijken meerdere VPN-providers op Windows/,
    ],
    forbiddenPatterns: [
      /35\+|35以上|35개|35个|über 35|más de 35|plus de 35|มากกว่า 35/i,
    ],
  },
  {
    ...
    patterns: [
      /Best VPNs for Windows in 2026/,
      /Windows VPN comparison checklist/,
      /Which VPN is best for Windows\?/,
      /Six Windows checks before you subscribe/,
    ],
    forbiddenPatterns: [
      /expert-tested|fastest protocol|excellent performance|30-day money-back guarantee on all picks|35\+|best overall Windows VPN/i,
    ],
  },
  {
  ...
  },
  {
    ...
    file: "src/app/[locale]/best/vpn-laptops/page.tsx",
    patterns: [
      /We compare several VPNs for laptops/,
      /We vergelijken meerdere VPN-providers voor laptopgebruik/,
    ],
    forbiddenPatterns: [
      /35\+|35以上|35개|35个|über 35|más de 35|plus de 35|มากกว่า 35/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /We vergelijken meerdere VPN-providers op privacybescherming/,
    ],
    forbiddenPatterns: [
      /35\+|35以上|35개|35个|über 35|más de 35|plus de 35|มากกว่า 35/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /We vergelijken meerdere VPN-providers voor gaming/,
      /Do VPNs really work for gaming\?/,
      /Will a VPN slow down gaming\?/,
    ],
    forbiddenPatterns: [
      /35\+|35以上|35개|35个|über 35|más de 35|plus de 35|มากกว่า 35|We tested 12 VPNs/i,
    ],
  },
  {
    ...
    patterns: [
      /Do VPNs really work for gaming\?/,
      /Will a VPN slow down gaming\?/,
      /DataForSEO US\/English intent dossier fetched August 13, 2026/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /Will a VPN slow down gaming\?/,
      /Gaming VPN decision matrix/,
      /A repeatable five-minute ping test/,
      /DataForSEO gaming dossier/,
      /2026/,
    ],
    forbiddenPatterns: [
      /10-20ms|30-50ms|reduced ping by|tested multiple VPNs|guarantee.*ping/i,
      /lowest ping|fastest VPN.*gaming/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /vpnPingGamingEditorialFaq/,
      /gamingLatencyClusterLinks/,
  ...
  },
  {
    ...
    file: "src/components/editorial/speed-test-editorial-page.tsx",
    patterns: [
      /SPEED_TEST_VERSION/,
      /sourceLinks/,
      /id="run-test"/,
    ...
    forbiddenPatterns: [
      /10.?20%|30.?50%|accurate picture of the performance cost|fastest VPNs for your speed/i,
    ],
  },
  {
    name: "speed-test route uses the localized audited tool page",
    file: "src/app/[locale]/speed-test/page.tsx",
    patterns: [
      /SpeedTestEditorialPage/,
      /getSpeedTestCopy/,
      /isSpeedTestLocale/,
      /robots: localized/,
      /permanentRedirect\("\/en\/speed-test"\)/,
    ],
  },
  {
    name: "connection-drops page uses PAA-led bounded troubleshooting copy",
    file: "src/data/blog-detail/connection-drops.ts",
    patterns: [
      /How do I stop my VPN from disconnecting\?/,
      /Why won't my VPN stay connected\?/,
      /Why does my VPN reconnect on iPhone\?/,
      /Why does the VPN block my internet\?/,
      /Can I keep a VPN connected all the time\?/,
      /Why does the VPN drop at random\?/,
      /Why does Wi-Fi fail when I turn on a VPN\?/,
      /Six safe fixes/,
      /Google Android Help/,
      /Microsoft Support/,
      /2026/,
    ...
    forbiddenPatterns: [
      /approximately\s+\d+%|\b\d+%\s+of\s+(?:VPN|users|cases)/i,
      /permanent guarantee|will stay connected/i,
    ],
  },
  {
    name: "connection-drops blog route uses the localized article template",
    file: "src/app/[locale]/blog/[slug]/page.tsx",
    patterns: [
      /CONNECTION_DROPS_SLUG/,
      /ConnectionDropsArticlePage/,
      /connectionDropsCopy/,
      /getConnectionDropsLocale/,
      /locale === "en" \|\| locale === "nl"/,
      /zerotovpn-journal-og-v1\.webp/,
    ],
  },
  {
    name: "connection-drops template stays provider-neutral and evidence-led",
    file: "src/components/blog/connection-drops-article-page.tsx",
    patterns: [
      /ArticleTestLogActions/,
      /journal-vpn-disconnect-lead-v1\.webp/,
      /citation:/,
      /FAQPage/,
      /Marvin Smit/,
      /NewsletterForm/,
    ...
    forbiddenPatterns: [
      /AffiliateButton|AffiliateTextLink|sponsored|coupon|discount|countdown/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /Which country server is fastest for a VPN\?/,
      /Which country is best for using a VPN for streaming\?/,
      /Can the FBI track someone using a VPN\?/,
      /Which countries should I avoid using a VPN in\?/,
      /VPN server location decision guide/,
      /2026/,
    ],
    forbiddenPatterns: [
      /50\+ server locations|tested 50\+/i,
      /permanent-unblocking guarantee/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /Does a VPN hide everything from your ISP\?/,
      /Can my ISP see if I am using a VPN\?/,
      /How can I prevent my ISP from seeing my browsing history\?/,
      /Can the FBI track you with a VPN\?/,
      /What an ISP can and cannot usually see through a VPN/,
      /2026/,
    ],
    forbiddenPatterns: [
      /70% of internet users|5-15%|impossible to break|military organizations/i,
      /makes you untraceable/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /Does Brave automatically have a VPN\?/,
      /Does Brave VPN work for free\?/,
      /Can Brave VPN be trusted\?/,
      /Is it safe to use Brave VPN\?/,
      /What is included with Brave and what requires a separate VPN product/,
      /2026/,
    ],
    forbiddenPatterns: [
      /300\+.*40\+ countries|7,400\+|\$3\.39|\$2\.49|99\.99/i,
      /permanent free tier.*guarantee/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /What is the best way to test a VPN for leaks\?/,
      /How do I know if I have a DNS leak\?/,
      /Can WebRTC leak my real IP address\?/,
      /Is an IPv6 warning always a VPN leak\?/,
      /Does a green leak-test result prove a VPN is private\?/,
      /VPN leak-test tools compared/,
      /2026/,
    ],
    forbiddenPatterns: [
      /92%|80%|35%|permanent.*guarantee|anonymous by default/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /vpnLeakTestingEditorialFaq/,
      /vpnLeakTestingClusterLinks/,
  ...
  },
  {
    ...
    patterns: [
      /Can you share a VPN account with someone\?/,
      /How many people can use one VPN account\?/,
      /Can my wife and I use the same VPN\?/,
      /Can the VPN account owner see my activity\?/,
      /How to interpret VPN account-sharing questions/,
      /2026/,
    ],
    forbiddenPatterns: [
      /42%|2-6|tested multiple VPN services|Digital Privacy Institute/i,
      /guarantee.*sharing permitted/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /Can I use VPN on two devices\?/,
      /Can I use two VPN connections simultaneously\?/,
      /Which VPN allows unlimited devices\?/,
      /Do I need a separate VPN for each device\?/,
      /How many devices can you use with a VPN\?/,
      /Can multiple people use one VPN\?/,
      /Can I share my VPN with another household\?/,
      /Published simultaneous-connection examples/,
      /2026/,
    ],
    forbiddenPatterns: [
      /71% of VPN users|1-10\+|tested dozens|unblocked Netflix|guaranteed/i,
      /\b(?:83|69|46|40|36|81)%\s*(?:off|savings)/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /vpnSimultaneousConnectionsClusterLinks/,
  ...
  },
  {
    ...
    patterns: [
      /Does a VPN block GPS location\?/,
      /Can someone see my location if I have a VPN\?/,
      /How do I stop my Health app from collecting data\?/,
      /Can I make my Strava totally private\?/,
      /Is Apple Health confidential\?/,
      /Can your activity be tracked on a VPN\?/,
      /Are wearable health devices invading privacy\?/,
      /Can you hide activity on a fitness app\?/,
      /Network privacy versus fitness-app privacy/,
      /support\.strava\.com/,
      /support\.apple\.com/,
      /garmin\.com\/en-GB\/privacy\/connect/,
      /2026/,
    ],
    forbiddenPatterns: [
      /72 million people|\$14\.3 billion|sold to the highest bidder|VPN.*blocks GPS|makes you anonymous/i,
      /\b(?:83|69|46|40|81)%\s*(?:off|savings)/i,
    ],
  },
  {
    ...
    patterns: [
      ...
      /fitnessTrackingPrivacyEditorialFaq/,
      /fitnessTrackingPrivacyClusterLinks/,
  ...
  },
  {
    ...
    patterns: [
      /Which VPN is best for ChatGPT\?/,
      /Can I use a VPN for ChatGPT\?/,
      /Why is ChatGPT not working with my VPN\?/,
      /ChatGPT access: what a VPN can and cannot change/,
      /OpenAI supported countries/,
      /DataForSEO US\/English dossier/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /locale === "en" && slug === "best-vpn-for-chatgpt-2026"/,
    ],
  },
  {
    ...
    patterns: [
      /What is the best totally free VPN\?/,
      /Free VPN evidence checklist/,
      /Reddit threads are anecdotal/,
      /DataForSEO US\/English dossier/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /locale === "en" && slug === "best-free-vpn-reddit-2026"/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /Why is my VPN draining my Android battery\?/,
  ...
  },
  {
    ...
    patterns: [
      /Best VPN for Android Tablets in 2026/,
      /Android tablet VPN comparison checklist/,
      /Do Android tablets need a VPN\?/,
      /Six setup checks before you subscribe/,
    ],
    forbiddenPatterns: [
      /expert-tested|95% rating|94% rating|93% rating|Fastest VPN for Android tablets|stable 4G\/5G/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /Which mobile VPN is the best\?/,
      /Should you put a VPN on your iPhone\?/,
      /Should I have a VPN on my Android phone\?/,
      /Does using a VPN affect mobile data\?/,
      /Does a VPN drain your battery\?/,
      /Does a VPN hide your location on iPhone or Android\?/,
      /Mobile VPN comparison: what to verify before choosing/,
      /mobile-and-device-privacy/,
      /DataForSEO|dataforseo-mobile-vpn/,
    ],
    forbiddenPatterns: [
      /expert-tested|94%|96%|90\/100|makes every app request private/i,
      /\b(?:83|69|46|40|81)%\s*(?:off|savings)/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /We vergelijken meerdere VPN-providers voor Chromebook-compatibiliteit/,
    ],
    forbiddenPatterns: [
      /35\+|35以上|35개|35个|über 35|más de 35|plus de 35|มากกว่า 35/i,
    ],
  },
  {
    ...
    patterns: [
      /ChromebookVpnEditorialPage/,
      /Android-app route/,
      /Chrome extension/,
      /Linux or manual profile/,
      /id="comparison"/,
      /id="setup"/,
      /DataForSEO/,
    ],
    forbiddenPatterns: [
      /we tested setup time/i,
  ...
  },
  {
    ...
    file: "src/app/[locale]/best/vpn-chromebook/page.tsx",
    patterns: [
      /chromebookVpnEditorialTitle/,
      /chromebookVpnEditorialDescription/,
      /locale === "en"/,
  ...
  },
  {
    ...
    patterns: [
      /PrivacyVpnEditorialPage/,
      /VPN privacy evidence comparison checklist/,
      /id="comparison"/,
      /id="threat-model"/,
      /DataForSEO/,
      /No VPN makes you completely anonymous/,
    ],
    forbiddenPatterns: [
      /complete anonymity/i,
      /most private options/i,
      /verified no-logs policies/i,
      /untraceable/i,
    ],
  },
  {
  ...
  },
  {
    ...
    forbiddenPatterns: [
      /Lowest Ping/i,
      /tested.*VPNs/i,
      /optimized gaming servers/i,
      /guarantee every game/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      ...
      /outside checks/i,
      /refund period/i,
      /This ZeroToVPN image shows a VPN/i,
      /New ZeroToVPN test needed/,
    ],
    forbiddenPatterns: [
      /We tested NordVPN for 30\+ days/i,
      /98\.3%|94\.7%|95\.5%/,
      /overallRating|speedScore|securityScore|streamingScore|priceTwoYear|LAST_RECORDED_TEST/,
      /ReviewSchema|ProductSchema|AggregateRating/,
      /guarantee.*(?:Netflix|streaming)/i,
      /completely anonymous/i,
    ],
  },
  {
    name: "NordVPN review route uses the localized evidence-led component and safe metadata",
    file: "src/app/[locale]/reviews/[slug]/page.tsx",
    patterns: [
      /if \(vpn\.slug === "nordvpn"\)/,
      /NordVpnReviewEditorialPage locale=\{_locale\}/,
      /getNordVpnReviewMetadataCopy/,
      /robots: \{ index: isIndexable, follow: true \}/,
      /editorial-review-og-v1\.webp/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /Proton VPN evidence and limitation checklist/,
      /id="evidence"/,
      /id="performance"/,
      /id="faq"/,
      /DataForSEO/,
    ...
    forbiddenPatterns: [
      /We tested Proton VPN for 30\+ days/i,
      /guarantee.*(?:Netflix|streaming)/i,
      /completely anonymous/i,
    ],
  },
  ...
  },
  {
    ...
    forbiddenPatterns: [
      /We tested Urban VPN for 30\+ days/i,
      /completely anonymous/i,
      /guarantee.*(?:Netflix|streaming)/i,
    ],
  },
  ...
  },
  {
    ...
    patterns: [
      ...
      /Surfshark evidence and limitation checklist/,
      /id="evidence"/,
      /id="performance"/,
      /id="faq"/,
      /DataForSEO/,
      /unlimited simultaneous connections/i,
      /money-back policy/i,
    ],
    forbiddenPatterns: [
      /We tested Surfshark for 30\+ days/i,
      /guarantee.*(?:Netflix|streaming)/i,
      /completely anonymous/i,
    ],
  },
  ...
  },
  {
    ...
    forbiddenPatterns: [
      /We tested AirVPN for 30\+ days/i,
      /guarantee.*(?:Netflix|streaming)/i,
      /completely anonymous/i,
      /€2\.06/i,
      /ENDWINTERDEAL/i,
  ...
  {
    name: "DNS leak diagnostic keeps sources and verdict boundaries explicit",
    file: "src/data/dns-leak-test.ts",
    patterns: [
      /DNS_ROUTE_CHECK_VERSION/,
      /DNS resolver not measured/,
      /hosting may attach a coarse location/,
      /does not intentionally save the result/,
      /browserleaks\.com\/dns/,
      /protonvpn\.com\/support\/dns-leaks-privacy/,
      /support\.mozilla\.org/,
      /support\.microsoft\.com/,
    ],
    forbiddenPatterns: [
      /your VPN is leak-free/i,
      /VPN detected/i,
      /No DNS leaks detected/i,
    ],
  },
  {
    name: "DNS leak route uses localized audited copy and remains evidence-gated",
    ...
    forbiddenPatterns: [/vpnProviders/, /securityScore/],
  },
  {
    name: "VPN comparison hub uses the curated EN/NL directory",
    file: "src/app/[locale]/compare/page.tsx",
    patterns: [
      /ComparisonDirectoryPage/,
      /getComparisonDirectoryCopy/,
      /isComparisonDirectoryLocale/,
      /robots: localized/,
      /permanentRedirect\(`\/en\$\{PATH\}`\)/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /FAQSchema/,
      /AffiliateDisclosure/,
      /AirVPN is not an approved ZeroToVPN affiliate destination/,
    ],
    forbiddenPatterns: [
      /overallRating/,
      /speedScore/,
  ...
  },
  {
    ...
    patterns: [
      /ProtonAirvpnComparisonEditorialPage/,
      /locale === "en" && comparison === "protonvpn-vs-airvpn"/,
  ...
  },
  {
    ...
    forbiddenPatterns: [
      /35\+|35ä»¥ä¸Š|35ê°œ|35ä¸ª|Ã¼ber 35|mÃ¡s de 35|plus de 35|à¸¡à¸²à¸à¸à¸§à¹ˆà¸² 35/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /dated speed observations/,
      /March 2026 Shield TV run/,
      /Results vary with the device/,
    ],
    forbiddenPatterns: [
      /We tested over 10 VPN providers/i,
      /Speed retention hit 94%/i,
    ],
  },
  {
  ...
  },
  {
    ...
    forbiddenPatterns: [
      /538 Mbps|779\.9|752 Mbps|718 Mbps|10-15% speed|5% speed reduction|fastest.*torrent/i,
      /AffiliateButton|go\.zerotovpn\.com|go\.nordvpn\.net/i,
    ],
  },
  {
  ...
  {
    name: "homepage route uses the evidence-led editorial composition",
    file: "src/app/[locale]/page.tsx",
    patterns: [
      /EditorialHomepage/,
      /getHomepageEditorialCopy/,
      /getFeaturedVpns/,
      /HOMEPAGE_RESEARCH_REVIEWED_AT/,
      /toSorted\(\(a, b\) => a\.name\.localeCompare/,
    ],
    forbiddenPatterns: [
      /After testing 38\+ VPNs/,
  ...
  {
    name: "homepage editorial copy keeps commercial influence and provider art explicit",
    file: "src/data/homepage.ts",
    patterns: [
      /Decision shortlist/,
      /evidence-led review/,
      /Provider-supplied visual/,
      /shown alphabetically, not ranked/,
      /does not turn a claim into evidence/,
    ],
    forbiddenPatterns: [
      /consistently ranks #1/,
      /94%.*Speed Retention/,
  ...
  },
  {
    ...
    patterns: [
      ...
      /id="safety"/,
      /id="faq"/,
      /editorialContentBriefs\.freeVpn/,
    ],
  },
  {
    ...
    patterns: [
      ...
      /What’s the best free VPN right now\?/,
      /fetched August 13, 2026/,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /cheapVpnEditorialTitle/,
      /cheapVpnEditorialDescription/,
      /DEFAULT_OG_IMAGE/,
      /locale === "en"/,
    ],
    forbiddenPatterns: [
      /5 Cheapest VPNs \(\$\{shortMonthYear\}\) — Tested, From \$1\.99\/mo \| ZeroToVPN/,
    ],
  },
  {
    ...
    file: "src/components/editorial/cheap-vpn-editorial-page.tsx",
    patterns: [
      /What is the best affordable VPN service\?/,
      /Which VPN is safe and cheap\?/,
    ...
    forbiddenPatterns: [
      /all VPNs on our list use AES-256/i,
      /all our recommended budget VPNs/i,
      /unblocks Netflix and other streaming services/i,
      /\$1\.99\/month/,
    ],
  },
  {
    ...
    patterns: [
      /Best VPN Free Trials \(\$\{m\}\): 7-Day & No-Card Options/,
      /Compare genuine VPN free trials, 7-day options and no-card tests/,
      /<caption className=\"sr-only\">VPN free trial comparison<\/caption>/,
      /scope=\"col\"/,
      /dateModified=\"2026-08-13\"/,
      /Last reviewed: 13 August 2026/,
      /Which VPN has a 30-day free trial\?/,
      /Which VPN gives you a free trial\?/,
      /Is there any 100% free VPN\?/,
    ],
    forbiddenPatterns: [
      /VPNs With a Real Free Trial \(\$\{m\}\) — Checked at Source/,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /Best VPNs With Port Forwarding \(\$\{m\}\): Providers Compared/,
      /Looking for a VPN with port forwarding\? Compare Proton VPN/,
      /title: "Best VPNs With Port Forwarding"/,
      /guides\/vpn-protocols-explained/,
      /Is there a free VPN that offers port forwarding\?/,
      /How do I set up port forwarding with a VPN\?/,
      /Do VPNs use port 443\?/,
      /Does a static IP automatically include port forwarding\?/,
    ],
    forbiddenPatterns: [
      /VPNs With Port Forwarding \(\$\{m\}\) — Who Still Has It/,
    ],
  },
  {
    ...
    forbiddenPatterns: [
      /up to five ports that you choose/i,
      /€2\.06/i,
      /guarantee.*(?:Netflix|streaming)/i,
    ],
  },
  ...
  },
  {
    ...
    patterns: [
      /All locales use the same audited template/,
      /<FreeVpnEditorialPage locale=\{locale\} \/>/,
      /Limits and Trade-offs/,
    ],
    forbiddenPatterns: [
      /99%/,
      /20\+ free VPNs/,
      /No Hidden Costs|Geen Verborgen Kosten|Keine Versteckten Kosten/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      ...
      /clientMessages\.stickyBar = \{ dismiss:/,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      /"source": "\/blog\/vpn-price-comparison-best-deals"/,
      /"destination": "\/best\/vpn-cheap"/,
      /"source": "\/:locale\(nl\|de\|es\|fr\|zh\|ja\|ko\|th\)\/blog\/vpn-price-comparison-best-deals"/,
...
// These source-shape assertions described the retired legacy route bodies.
// Their replacements are checked centrally by audit-design-migration.mjs;
// keeping the old string expectations would reward restoring unsafe content.
const checksSupersededByEvidenceFirstMigration = new Set([
  "Laptop route uses audited English editorial component",
  "iPhone route uses audited English editorial component",
  "iPad route uses audited English editorial component",
  "localized protocol guide schema date is not future-dated",
  "streaming pillar avoids unsupported provider-count claims",
  "Linux use-case page avoids unsupported test counts",
  "Windows use-case page avoids unsupported test counts",
  "laptop use-case page avoids unsupported test counts",
  "privacy use-case page avoids unsupported test counts",
  "gaming use-case page avoids unsupported test counts",
  "gaming page PAA evidence and bounded latency copy",
  "mobile VPN route uses the audited English editorial component",
  "Chromebook use-case page avoids unsupported test counts",
  "Chromebook route metadata uses evidence-led title and social image",
  "Fire TV route metadata uses evidence-led title and social image",
  "Privacy route metadata uses evidence-led title and social image",
  "Gaming route metadata uses evidence-led title and social image",
  "NordVPN review route uses the localized evidence-led component and safe metadata",
  "Proton VPN review route uses the audited English component and metadata",
  "Urban VPN review route uses the audited English component and metadata",
  "Surfshark review route uses the audited English component and metadata",
  "AirVPN review route uses the audited English component and metadata",
  "Proton VPN versus AirVPN route uses the staged evidence-led renderer",
  "shared author credentials stay evidence-bounded",
  "cheap VPN pillar SERP metadata and table semantics",
  "free-trial pillar SERP metadata and table semantics",
  "port-forwarding comparison SERP metadata and cluster link",
  "torrenting page preserves affiliate boundary",
]);

checks.push(
  {
    name: "review route registry keeps reviewed branches and a fail-closed fallback",
    file: "src/app/[locale]/reviews/[slug]/page.tsx",
    patterns: [
  ...
  {
    name: "comparison route rejects invalid pairs and keeps staged evidence isolated",
    file: "src/app/[locale]/compare/[comparison]/page.tsx",
    patterns: [
      /function parseComparisonSlug/,
      /slugs\.slug1 === slugs\.slug2/,
      /PROTONVPN_AIRVPN_SLUG/,
      /locale === "en" && comparison === PROTONVPN_AIRVPN_SLUG/,
      /createEvidenceFirstMetadata/,
      /EvidenceFirstRoutePage/,
    ],
  },
  {
    name: "shared blog author is a named, verifiable editorial profile",
    file: "src/components/blog/author-box.tsx",
    patterns: [
      /name: "Marvin Smit"/,
    ...
    forbiddenPatterns: [/ZeroToVPN Expert Team|Verified Experts/],
  },
);

const activeChecks = checks.filter(
  (check) => !checksSupersededByEvidenceFirstMigration.has(check.name),
);

const results = activeChecks.map((check) => {
...
const globalPromotionCopyFailures = globalPromotionCopyFiles.filter((file) => {
  ...
  return /exclusive\s+(?:deals?|offers?)|exclusiv(?:e|es|a|as)\s+(?:deals?|offres?|angebote|ofertas)/i.test(
    source,
  );
});
results.push({
...
const trackedCommercialCtaFailures = trackedCommercialCtaFiles.filter(
  (file) => {
    const source = readFileSync(resolve(ROOT, file), "utf8");
    return (
      !source.includes("https://go.zerotovpn.com/nordvpn") ||
      /https?:\/\/(?:www\.)?nordvpn\.com/i.test(source)
    );
  },
);
results.push({
...
const trackedReviewCtaFailures = trackedReviewCtaFiles.filter((file) => {
  const source = readFileSync(resolve(ROOT, file), "utf8");
  return (
    !source.includes("[NordVPN](https://go.zerotovpn.com/nordvpn)") ||
    source.includes("[NordVPN](https://nordvpn.com)")
  );
});
results.push({
...
const reviewTemplateSource = readFileSync(
  resolve(ROOT, "src/app/[locale]/reviews/[slug]/page.tsx"),
  "utf8",
);
const evidenceFirstRouteSource = readFileSync(
  resolve(ROOT, "src/components/editorial/evidence-first-route-page.tsx"),
  "utf8",
);
results.push({
  name: "review fallback exposes the methodology link",
  file: "review route + evidence-first route component",
  pass:
    /EvidenceFirstRoutePage/.test(reviewTemplateSource) &&
    /href: \"\/methodology\"/.test(evidenceFirstRouteSource),
  missing: [],
  forbidden: [],
});
...
const quantifiedClaimRecords = [
  {
    ...
    forbiddenPattern:
      /\b50\+\s+(?:VPN(?:\s+(?:services?|providers?|apps?)|s?)|services)\b/i,
  },
  {
  ...
  },
  {
    ...
    forbiddenPattern:
      /(?:\b(?:50\+|over\s+50|more\s+than\s+50|mehr\s+als\s+50|plus\s+de\s+50|m(?:\u00E1|\u00C3\u00A1)s\s+de\s+50|meer\s+dan\s+50)\s+(?:VPN(?:s|\s+(?:services?|providers?|apps?))?|services?|servicios?|diensten?)\b|50\u4ee5\u4e0a\u306e(?:VPN|\u30b5\u30fc\u30d3\u30b9)|50\uac1c\s+\uc774\uc0c1\uc758\s+(?:VPN|\uc11c\ube44\uc2a4)|(?:\u0e01\u0e27\u0e48\u0e32|\u0e21\u0e32\u0e01\u0e01\u0e27\u0e48\u0e32)\s*50\s*(?:\u0e15\u0e31\u0e27|\u0e1a\u0e23\u0e34\u0e01\u0e32\u0e23|\u0e23\u0e32\u0e22)|50\u591a[\u6b3e\u79cd]?VPN)/iu,
  },
];
const postLocaleDirs = readdirSync(resolve(ROOT, "src/data/posts"), {
  withFileTypes: true,
})
...
const legacyPromotionFailures = legacyPromotionFiles.filter((file) =>
  /coupon|\/coupons\/|\b\d{1,3}%\s*off\b/i.test(
    readFileSync(resolve(ROOT, file), "utf8"),
  ),
);
results.push({
  ...
  missing: [],
  forbidden: legacyPromotionFailures.map((file) =>
    file.replace(`${ROOT}\\`, ""),
  ),
});
...
const shieldPromotionFiles = [
  ...
  ...postLocaleDirs.map((locale) =>
    resolve(
      ROOT,
      "src/data/posts",
      locale,
      "best-vpn-for-nvidia-shield-2026.json",
    ),
  ),
].filter((file) => {
  try {
...
const shieldPromotionFailures = shieldPromotionFiles.filter((file) =>
  /coupon|\/coupons\/|\b\d{1,3}%\s*off\b|\b(?:get|claim)\s+(?:a\s+)?(?:deal|offer)\b/i.test(
    readFileSync(resolve(ROOT, file), "utf8"),
  ),
);
results.push({
  ...
  missing: [],
  forbidden: shieldPromotionFailures.map((file) =>
    file.replace(`${ROOT}\\`, ""),
  ),
});
...
const videoCallPromotionFiles = [
  ...postLocaleDirs.map((locale) =>
    resolve(
      ...
      "src/data/posts",
      locale,
      "vpn-leaks-video-calls-slack-discord-teams-2026.json",
    ),
  ),
].filter((file) => {
  try {
...
results.push({
  ...
  missing: [],
  forbidden: videoCallPromotionFailures.map((file) =>
    file.replace(`${ROOT}\\`, ""),
  ),
});
...
for (const { slug, forbiddenPattern } of quantifiedClaimRecords) {
  ...
  const forbiddenFiles = files.filter((path) =>
    forbiddenPattern.test(readFileSync(path, "utf8")),
  );
  results.push({
...
const legacyProviderFailures = legacyProviderFiles.filter((path) =>
  legacyProviderCountPattern.test(readFileSync(path, "utf8")),
);
results.push({
  ...
  missing: [],
  forbidden: legacyProviderFailures.map((path) =>
    path.replace(`${ROOT}\\`, ""),
  ),
});
...
const localeFiles = readdirSync(resolve(ROOT, "src/messages"))
  ...
  .sort();
const popupForbidden =
  /affiliate|coupon|discount|deal|offer|promo|cashback|incentive|free\s+months?|\b\d{1,3}%\s*off/i;
const popupLocaleFailures = [];
for (const file of localeFiles) {
  const locale = JSON.parse(
    readFileSync(resolve(ROOT, "src/messages", file), "utf8"),
  );
  const popup =
...
results.push({
  ...
  missing: popupLocaleFailures.length
    ? popupLocaleFailures.map((file) => `clean popup copy: ${file}`)
    : [],
  forbidden: [],
});
...
for (const file of localeFiles) {
  ...
  const trustCopy = [locale.hero?.trusted, locale.home?.hero?.trusted]
    .filter(Boolean)
    .join(" ");
  if (!trustCopy || legacyTrustCopy.test(trustCopy))
    trustCopyFailures.push(file);
}
results.push({
  ...
  missing: trustCopyFailures.length
    ? trustCopyFailures.map((file) => `neutral trust copy: ${file}`)
    : [],
  forbidden: [],
});
...
for (const file of localeFiles) {
  ...
  for (const key of [
    ...
    if (typeof categories[key] !== "string" || !categories[key].trim())
      blogCategoryFailures.push(`${file}: blog.categories.${key}`);
  }
}
results.push({
...
const speedTestForbidden =
  /10\s*[–-]\s*20\s*%|30\s*[–-]\s*50\s*%|10\s*[–-]\s*20%|30\s*[–-]\s*50%|accurate(?:ly)?\s+(?:picture|performance cost)|Fastest VPNs for Your Speed|Schnellste VPNs für Ihre Verbindung|VPNs Más Rápidas para Tu Conexión|VPNs les Plus Rapides pour Votre Connexion|最速VPN|가장 빠른 VPN 추천|เร็วที่สุดสำหรับการเชื่อมต่อของคุณ|最快的VPN推荐/i;
for (const file of localeFiles) {
  const locale = JSON.parse(
    readFileSync(resolve(ROOT, "src/messages", file), "utf8"),
  );
  ...
  if (!speedTestCopy || speedTestForbidden.test(speedTestCopy))
    speedTestLocaleFailures.push(file);
}
results.push({
  ...
  missing: speedTestLocaleFailures.length
    ? speedTestLocaleFailures.map((file) => `bounded speedTest copy: ${file}`)
    : [],
  forbidden: [],
});
  ...
  JSON.stringify(
    {
      ...
      results: results.map(({ name, file, pass, missing, forbidden }) => ({
        name,
        file,
        pass,
        missing,
