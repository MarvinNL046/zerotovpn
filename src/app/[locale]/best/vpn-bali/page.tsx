...
const content: Record<string, {
  ...
  zh: {
    ...
    related: [
      ...
      { title: "印度尼西亚最佳VPN", description: "印度尼西亚的国家背景和经过测试的推荐。", href: "/best/vpn-indonesia", icon: "globe" },
      { title: "泰国最佳VPN", description: "经过测试的旅行VPN推荐。", href: "/best/vpn-thailand", icon: "globe" },
  ...
  ja: {
    ...
    related: [
      ...
      { title: "インドネシアにおすすめのVPN", description: "インドネシアの状況とテスト済みのおすすめ。", href: "/best/vpn-indonesia", icon: "globe" },
      { title: "タイにおすすめのVPN", description: "テスト済みのおすすめを掲載した旅行向けVPNページ。", href: "/best/vpn-thailand", icon: "globe" },
  ...
  ko: {
    ...
    related: [
      ...
      { title: "인도네시아 최고의 VPN", description: "인도네시아 현지 상황과 테스트를 거친 추천.", href: "/best/vpn-indonesia", icon: "globe" },
      { title: "태국 최고의 VPN", description: "테스트를 거친 추천이 포함된 여행용 VPN 페이지.", href: "/best/vpn-thailand", icon: "globe" },
  ...
  th: {
    ...
    related: [
      ...
      { title: "VPN ที่ดีที่สุดสำหรับอินโดนีเซีย", description: "บริบทของประเทศและคำแนะนำที่ผ่านการทดสอบสำหรับอินโดนีเซีย", href: "/best/vpn-indonesia", icon: "globe" },
      { title: "VPN ที่ดีที่สุดสำหรับไทย", description: "หน้า VPN สำหรับนักเดินทางพร้อมคำแนะนำที่ผ่านการทดสอบ", href: "/best/vpn-thailand", icon: "globe" },
