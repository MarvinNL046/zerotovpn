  ...
  const content = {
    en: {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "Budget VPNs achieve low prices by offering discounts on long-term plans (2-3 years paid upfront). The monthly price for Surfshark is $15.45 but drops to $2.49/month on a 2-year plan. They also have lower marketing budgets compared to ExpressVPN.",
        },
        {
          question: "What is the cheapest VPN overall?",
          answer: "Surfshark at $2.49/month (2-year plan) is the cheapest premium VPN in 2026 that we recommend. It offers unlimited devices, fast speeds, and unblocks Netflix and other streaming services. For a free option, ProtonVPN has a limited free tier.",
        },
        {
        ...
        },
        {
          ...
          answer: "We do not recommend free VPNs for most users. They typically have severe data limits (500MB-2GB/month), very slow speeds, and many sell your browsing data. ProtonVPN is the only trustworthy free option but its free tier lacks streaming support. Surfshark at $2.49/month is a much better investment.",
        },
      ],
      getVpnButton: "Get",
    ...
    zh: {
      ...
      faqs: [
        ...
        { question: "最便宜的VPN是什么？", answer: "Surfshark $2.49/月（2年方案）。" },
    ...
    ja: {
      ...
      faqs: [
        ...
        { question: "最安VPNは？", answer: "Surfshark月額$2.49（2年プラン）。" },
    ...
    ko: {
      ...
      faqs: [
        ...
        { question: "가장 저렴한 VPN은?", answer: "Surfshark 월 $2.49 (2년 플랜)." },
    ...
    th: {
      ...
      faqs: [
        ...
        { question: "ตัวไหนถูกที่สุด?", answer: "Surfshark ที่ $2.49/เดือน (แผน 2 ปี)" },
