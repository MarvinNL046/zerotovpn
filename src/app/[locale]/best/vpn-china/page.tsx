...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: generateAlternates("/best/vpn-china", locale),
  };
}
      ...
      <div className="flex flex-col">
        ...
        <section className="relative py-16 lg:py-24 overflow-hidden">
          ...
          <div className="container relative">
            <BreadcrumbSchema
              items={[{ name: "Best VPNs", href: "/best/best-vpn" }, { name: "VPN for China", href: "/best/vpn-china" }]}
              className="mb-6"
            />
        ...
        <RelatedPages
          ...
          pages={[
            ...
            { title: "Best VPN for Iran", description: "Top VPNs for bypassing Iranian censorship", href: "/countries/iran", icon: "globe" },
