                ...
                <RankedVpnRow
                  ...
                  middle={
                    <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
                      <>
                      <div className="flex items-center gap-2 text-sm"><Tv className="size-4 text-orange-500" aria-hidden="true" /><span>Native App</span></div>
                      ...
                      <div className="flex items-center gap-2 text-sm"><Monitor className="size-4 text-blue-500" aria-hidden="true" /><span>4K Streaming</span></div>
                      <div className="flex items-center gap-2 text-sm">
                        {item.splitTunneling ? <CheckCircle className="size-4 text-green-600" aria-hidden="true" /> : <XCircle className="size-4 text-muted-foreground" aria-hidden="true" />}
                        <span>Split Tunnel</span>
                      </div>
                      <div className="flex items-center gap-2 text-sm"><Play className="size-4 text-green-600" aria-hidden="true" /><span>App: {item.appRating}/5</span></div>
                    </>
                    </div>
                  }
                />
