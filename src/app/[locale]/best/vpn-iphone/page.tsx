...
import { IphoneVpnEditorialPage } from "@/components/editorial/iphone-vpn-editorial-page";
import {
...
export default async function IphoneVpnPage({ params }: Props) {
  ...
  if (locale === "en") {
    return <IphoneVpnEditorialPage vpns={await getAllVpns()} />;
  }
  return (
