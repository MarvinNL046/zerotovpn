...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: generateAlternates("/best/vpn-torrenting", locale),
  };
}
                ...
                <RankedVpnRow
                  ...
                  middle={
                    <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
                      <>
                      <div className="flex items-center gap-2 text-sm"><Server className="size-4 text-green-600" aria-hidden="true" /><span>{item.p2pServers} P2P</span></div>
                      ...
                      <div className="flex items-center gap-2 text-sm"><Shield className="size-4 text-blue-500" aria-hidden="true" /><span>Kill Switch</span></div>
                      <div className="flex items-center gap-2 text-sm"><Lock className="size-4 text-green-600" aria-hidden="true" /><span>No Logs</span></div>
                      {item.portForwarding && <div className="flex items-center gap-2 text-sm"><CheckCircle className="size-4 text-green-600" aria-hidden="true" /><span>Port Forward</span></div>}
                      {item.socks5Proxy && <div className="flex items-center gap-2 text-sm"><CheckCircle className="size-4 text-green-600" aria-hidden="true" /><span>SOCKS5</span></div>}
                    </>
                    </div>
                  }
                />
