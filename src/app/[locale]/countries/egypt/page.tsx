...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      locale: OG_LOCALE_MAP[locale] ?? "en_US", title: titles[locale] || titles.en, description: descriptions[locale] || descriptions.en, type: "article" },
        ...
        middle={
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">{index === 0 && t.effectiveness94}{index === 1 && t.effectiveness92}{index === 2 && t.effectiveness89}{index === 3 && t.effectiveness85}</span>
            </div>
            <div className="flex items-center gap-2">
