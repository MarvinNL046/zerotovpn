                ...
                <RankedVpnRow
                  ...
                  middle={
                    <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                      <div className="flex items-center gap-2"><AlertTriangle className="size-5 text-green-600 dark:text-green-500" aria-hidden="true" /><span className="text-sm">{t.mayWorkInRussia}</span></div>
          ...
          <div className="container">
            <RelatedPages
              ...
              pages={[
                ...
                { title: "VPN Guide: Turkey", description: "Access blocked services in Turkey", href: "/countries/turkey", icon: "globe" },
