...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: generateAlternates("/countries/uae", locale),
  };
}
              ...
              <RankedVpnRow
                ...
                middle={
                  <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                    <div className="flex items-center gap-2"><CheckCircle className="size-5 text-green-600 dark:text-green-500" aria-hidden="true" /><span className="text-sm">{t.worksInUAE}</span></div>
