      ...
      <section className="py-16 lg:py-20 bg-gradient-to-br from-cyan-500/10 via-background to-background">
        <div className="container">
          <div className="max-w-3xl mx-auto">
            <BreadcrumbSchema items={[{ name: "Guides", href: "/guides" }, { name: "VPN for Travel", href: "/guides/vpn-for-travel" }]} className="mb-6" />
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              <div className="flex items-center gap-1">
                ...
                {t("hero.updated", { month: getLocalizedMonthYear(locale) })}
              </div>
              <div className="flex items-center gap-1">
