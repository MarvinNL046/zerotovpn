...
const faq = [
  { question: "Which is the best VPN in 2026?", answer: "There is no single best VPN for every device, network or task. Use the shortlist as a starting point, then compare current plan terms, privacy evidence, protocol support and the exact service you need to protect or access." },
  ...
  { question: "Which VPN do hackers use?", answer: "That is not a useful or reliable way to choose a VPN. Judge a provider by ownership, privacy documentation, technical design, current terms and reproducible checks—not by an unverifiable association with criminal activity." },
