...
export function EvidenceLedVpnUseCasePage({
  ...
  return (
    <main className="bg-background text-foreground">
      ...
      <section className="container pb-10 text-sm text-muted-foreground"><p className="max-w-4xl leading-6">ZeroToVPN is not currently publishing a provider ranking on this page because the retained evidence does not support one. Read the <Link href="/methodology" className="font-semibold text-teal-800 underline-offset-4 hover:underline dark:text-teal-300">research methodology</Link> and verify legal, contractual, privacy, and service-availability requirements for your situation.</p></section>
    </main>
  );
}
