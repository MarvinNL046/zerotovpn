...
export function IranEditorialQuickPicks({
  ...
  description = "These cards are contextual affiliate links to providers worth checking. They are not proof that any service currently connects from Iran; verify the live documentation and your own network before relying on one.",
    ...
    <section id="quick-picks" aria-labelledby="iran-shortlist" className="container max-w-4xl pb-4">
      <div className="rounded-2xl border bg-muted/30 p-5 sm:p-6">
        <div className="mb-5 max-w-2xl">
          ...
          <h2 id="shortlist-heading" className="mt-2 text-2xl font-bold">{heading}</h2>
