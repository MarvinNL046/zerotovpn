...
export const protonAirvpnComparisonTitle =
  "Proton VPN vs AirVPN (August 2026): Privacy, Price and Port Forwarding";
export const protonAirvpnComparisonDescription =
  "Compare Proton VPN and AirVPN by privacy evidence, current plan terms, apps and port forwarding. Use the trade-offs—not a universal winner claim—to choose what to verify.";
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "The answer depends on the plan length, currency, introductory offer and renewal terms. Compare the current checkout totals rather than relying on a monthly equivalent. This page records catalog snapshots and does not treat a temporary promotion as a permanent price.",
  },
  {
    question: "Does AirVPN have port forwarding that Proton VPN does not?",
    answer:
      "AirVPN documents port forwarding as a core feature. Proton VPN also documents paid-plan port forwarding with its own limits. Read each provider's current support page and verify the exact account, server and protocol conditions before relying on an inbound service.",
  },
  {
    question: "Which provider is better for streaming?",
    answer:
      "Streaming access changes by service, region, account and server. Neither provider should be treated as a permanent streaming guarantee. Test the platform you are allowed to use during the applicable refund window and follow its terms.",
  },
  {
    question: "Which one is better for privacy?",
    answer:
      "Both publish privacy and technical documentation, but the evidence has different scope. Proton VPN publishes policy and audit material; AirVPN publishes policy, open-source client code and technical documentation. Compare the date, scope and independence of each source instead of converting them into a single score.",
  },
];
...
const criteria: Criterion[] = [
  ...
  },
  {
    ...
    airvpn:
      "Published privacy policy, open-source Eddie client and technical documentation",
    limit:
      "A policy, source-code review or audit has a defined scope; none is a permanent guarantee.",
  },
  {
    ...
    limit:
      "Confirm server, protocol and account conditions before relying on inbound connections.",
  },
  {
    ...
    limit:
      "App availability and usability can change; test your actual device.",
  },
  {
    label: "Streaming",
      ...
      <article className="container max-w-6xl py-8 lg:py-12">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h2 className="mt-2 text-3xl font-bold">
                  Choose the trade-off that matches your workflow
                </h2>
                <p className="mt-3 text-muted-foreground">
                  Proton VPN is the broader everyday option when app polish, a
                  free starting point and published audit material matter.
                  AirVPN is the specialist option when open-source tooling,
                  granular control and port forwarding matter. These are
                  decision boundaries, not performance guarantees.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            <article className="rounded-xl border bg-card p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                <li className="flex gap-2">
                  <CheckCircle2
                    ...
                    aria-hidden="true"
                  />
                  You want a more guided app experience across common devices.
                </li>
                <li className="flex gap-2">
                  <CheckCircle2
                    className="mt-0.5 size-5 shrink-0 text-green-600"
                    aria-hidden="true"
                  />
                  A no-payment starting point and published audit material are
                  useful to your decision.
                </li>
                <li className="flex gap-2">
                  <CheckCircle2
                    className="mt-0.5 size-5 shrink-0 text-green-600"
                    aria-hidden="true"
                  />
                  You can verify whether the current paid plan meets your device
                  and streaming needs.
                </li>
              </ul>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                ...
                {proton.priceLastVerified ?? "date not recorded"}; verify
              ...
              <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                <li className="flex gap-2">
                  <CheckCircle2
                    ...
                    aria-hidden="true"
                  />
                  Port forwarding and detailed connection control are
                  requirements.
                </li>
                <li className="flex gap-2">
                  <CheckCircle2
                    ...
                    aria-hidden="true"
                  />
                  You are comfortable checking technical documentation and
                ...
                <li className="flex gap-2">
                  <CheckCircle2
                    ...
                    aria-hidden="true"
                  />
                  Streaming and a polished mobile workflow are not your primary
                  reason to subscribe.
                </li>
              </ul>
              <p className="mt-6 text-sm text-muted-foreground">
                AirVPN is not an approved ZeroToVPN affiliate destination. We
                link to its first-party evidence for research and do not add a
                commercial AirVPN CTA.
              </p>
              <Link
                href="/reviews/airvpn"
                className="mt-4 inline-flex text-sm font-semibold text-primary underline"
              >
                Read the AirVPN evidence review
              </Link>
            </article>
          </div>
        </section>
        ...
        <section id="comparison" className="mt-16 scroll-mt-24">
          ...
          <p className="mt-3 max-w-4xl text-muted-foreground">
            The table keeps the claim, evidence boundary and decision limit
            together. It intentionally excludes fixed scores, lab percentages
            and universal winner labels.
          </p>
          <div className="mt-6 overflow-x-auto rounded-xl border">
            <table className="w-full min-w-[980px] text-left text-sm">
              <caption className="sr-only">
                Proton VPN and AirVPN comparison by decision criteria
              </caption>
              ...
              <tbody>
                {criteria.map((criterion) => (
                  <tr key={criterion.label} className="border-t">
                    <th
                      scope="row"
                    ...
                    <td className="p-4">{criterion.proton}</td>
                    <td className="p-4">{criterion.airvpn}</td>
        ...
        <section id="method" className="mt-16 scroll-mt-24">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            <div className="rounded-xl border p-5">
              ...
              <h3 className="mt-3 font-semibold">Read the scope</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Open each provider policy, audit or technical page and note its
                date and defined scope.
              </p>
            </div>
            <div className="rounded-xl border p-5">
              <Scale className="size-6 text-primary" aria-hidden="true" />
              <h3 className="mt-3 font-semibold">Test your device</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Compare reconnects, DNS/WebRTC exposure, protocol support and
            ...
            <div className="rounded-xl border p-5">
              <CheckCircle2
                ...
                aria-hidden="true"
              />
              <h3 className="mt-3 font-semibold">Verify checkout</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Confirm price, renewal, refund eligibility, device limits and
                port-forwarding conditions before subscribing.
              </p>
            </div>
          </div>
        ...
        <section id="sources" className="mt-16 scroll-mt-24 border-t pt-8">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            DataForSEO informed query and PAA coverage. Provider pages and the
            ZeroToVPN methodology are the source of record for current terms;
            search data is not evidence of safety, speed or conversion value.
          </p>
          <ul className="mt-4 grid gap-2 text-sm sm:grid-cols-2">
            ...
            <li>
              ...
              >
                <Link2 className="size-4" aria-hidden="true" />
                Proton VPN free-plan documentation
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              <Link href="/reviews/airvpn" className="text-primary underline">
                AirVPN review
              </Link>
            </li>
            <li>
