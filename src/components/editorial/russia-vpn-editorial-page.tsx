...
const faq = [
  ...
  { question: "Which VPNs work in Russia in 2026?", answer: "There is no reliable universal ranking: access can change by ISP, region, app version and protocol. Use current provider documentation as a starting point, then test the exact device and network you need." },
  { question: "Which VPN supports Russia?", answer: "Support can mean an account, an app download, a server route or a connection that survives filtering. Check each of those separately in current documentation instead of treating a provider list as proof of access." },
  { question: "Can you use a VPN in Russia?", answer: "A VPN may connect on some networks, but availability and the legal position can change. Prepare an official app and fallback plan in advance, and verify current authoritative guidance for your specific use." },
